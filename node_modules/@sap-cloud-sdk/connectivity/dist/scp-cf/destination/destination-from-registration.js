...
function decodedJwtOrZid(options) {
    ...
    const providerTenantId = (0, subdomain_replacer_1.parseSubdomain)((0, environment_accessor_1.getXsuaaServiceCredentials)(options === null || options === void 0 ? void 0 : options.jwt).url);
