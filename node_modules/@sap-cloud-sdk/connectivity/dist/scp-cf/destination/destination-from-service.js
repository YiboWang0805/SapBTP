...
class DestinationFromServiceRetriever {
    ...
    static async getSubscriberToken(options) {
        if (options.jwt) {
            ...
            return {
                userJwt: {
                    decoded: await (0, jwt_1.verifyJwt)(options.jwt, options),
                    encoded: options.jwt
                },
                serviceJwt: { encoded, decoded: (0, jwt_1.decodeJwt)(encoded) }
            };
        }
        if (options.iss) {
            ...
            const clientCertJwt = { encoded, decoded: (0, jwt_1.decodeJwt)(encoded) };
...
Possible alternatives for such technical user authentication are BasicAuthentication, OAuth2ClientCredentials, or ClientCertificateAuthentication`);
    ...
    async getAuthTokenForOAuth2UserBasedTokenExchanges(destinationResult) {
        ...
        const serviceJwt = origin === 'subscriber'
    ...
    isProviderAndSubscriberSameTenant() {
    ...
    async addTrustStoreConfiguration(destination, origin) {
        ...
        if ((_a = destination.originalProperties) === null || _a === void 0 ? void 0 : _a.TrustStoreLocation) {
            const trustStoreCertificate = await (0, destination_service_1.fetchCertificate)(this.destinationServiceCredentials.uri, origin === 'subscriber'
                ? this.subscriberToken.serviceJwt.encoded
                : this.providerServiceToken.encoded, destination.originalProperties.TrustStoreLocation);
