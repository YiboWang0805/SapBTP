...
function execute(executeFn) {
    return async function (destination, requestConfig, options) {
        ...
        logCustomHeadersWarning((_a = requestConfig.headers) === null || _a === void 0 ? void 0 : _a.custom);
...
function buildHeaders(destination) {
    return (0, connectivity_1.buildHeadersForDestination)(destination).catch(error => {
