...
class EntityBase {
    constructor(schema) {
        this.schema = schema;
        (0, properties_util_1.nonEnumerable)(this, 'schema');
    ...
    getCurrentStateForKey(key, visitedEntities = []) {
        if ((0, properties_util_1.isNavigationProperty)(key, this.schema)) {
    ...
    asObject(visitedEntities = []) {
        ...
        return Object.keys(this)
            ...
            (!(0, properties_util_1.isNavigationProperty)(key, this.schema) ||
