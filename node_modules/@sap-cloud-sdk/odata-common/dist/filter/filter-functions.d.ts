 ...
 * @internal
 */
export declare type FilterFunctionTypes = typeof endsWith | typeof startsWith | typeof length | typeof indexOf | typeof substring | typeof toLower | typeof toUpper | typeof trim | typeof concat | typeof round | typeof floor | typeof ceiling | typeof day | typeof hour | typeof minute | typeof month | typeof second | typeof year | typeof isOf;
/**
 * @internal
 */
export declare type FilterFunctionNames = 'endsWith' | 'startsWith' | 'length' | 'indexOf' | 'substring' | 'toLower' | 'toUpper' | 'trim' | 'concat' | 'round' | 'floor' | 'ceiling' | 'day' | 'hour' | 'minute' | 'month' | 'second' | 'year' | 'isOf';
