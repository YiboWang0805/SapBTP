 ...
 */
export declare type ConstructorOrField<EntityT extends EntityBase, ComplexT = any> = Constructable<EntityT> | ComplexTypeField<EntityT, DeSerializers, ComplexT, boolean, boolean>;
