 ...
 */
declare type NullableFieldType<FieldT, NullableT extends boolean> = NullableT extends true ? FieldT | null : FieldT;
/**
 ...
 * @internal
 */
export declare type FieldTypeByEdmType<T extends DeSerializers, EdmT extends EdmTypeShared<'any'>, NullableT extends boolean> = NullableFieldType<DeserializedType<T, EdmT>, NullableT>;
/**
