...
declare type GetFilterType = <EntityT extends EntityBase, TargetEntityT extends EntityBase, DeSerializersT extends DeSerializers>(filter: Filterable<EntityT, DeSerializersT, any>, entityApi: EntityApi<TargetEntityT, DeSerializersT>) => Partial<{
    filter: string;
}>;
/**
