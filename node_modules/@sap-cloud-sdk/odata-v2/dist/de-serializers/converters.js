...
function deserializeToMoment(edmDateTime) {
    var _a;
    const dateTimeOffsetComponents = (_a = /^\/Date\((?<ticks>\d+)((?<sign>[+-])(?<offset>\d{4}))?\)\/$/.exec(edmDateTime)) === null || _a === void 0 ? void 0 : _a.groups;
    if (!dateTimeOffsetComponents) {
        throw new Error(`Failed to parse edmDateTime: ${edmDateTime} to moment.`);
    }
    const timestamp = (0, moment_1.default)(parseInt(dateTimeOffsetComponents.ticks));
