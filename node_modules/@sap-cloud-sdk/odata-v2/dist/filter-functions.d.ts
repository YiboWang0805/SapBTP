 ...
 * @internal
 */
export declare type FilterFunctionsType = FilterFunctionsCommonType & {
 ...
 * @internal
 */
export declare type FilterFunctionNames = FilterFunctionNamesCommon | 'substringOf' | 'replace';
