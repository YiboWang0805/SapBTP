 ...
 * @internal
 */
export declare type FilterFunctionTypes = FilterFunctionsCommonType & {
 ...
 * @internal
 */
export declare type FilterFunctionNames = FilterFunctionNamesCommon | 'contains' | 'matchesPattern' | 'fractionalSeconds' | 'totalOffsetMinutes' | 'maxDateTime' | 'minDateTime' | 'now' | 'hasSubset' | 'hasSubsequence';
