...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.ACLProductLinkage ACLProductLinkage}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ACLProductLinkageField<FieldT >
    extends EntityField<ACLProductLinkage, FieldT>
    implements ACLProductLinkageSelectable
{
     ...
     */
    public ACLProductLinkageField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ACLProductLinkageField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
