...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.APIProduct APIProduct}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class APIProductField<FieldT >
    extends EntityField<APIProduct, FieldT>
    implements APIProductSelectable
{
     ...
     */
    public APIProductField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public APIProductField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
