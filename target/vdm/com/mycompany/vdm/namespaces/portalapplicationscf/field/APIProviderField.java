...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.APIProvider APIProvider}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class APIProviderField<FieldT >
    extends EntityField<APIProvider, FieldT>
    implements APIProviderSelectable
{
     ...
     */
    public APIProviderField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public APIProviderField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
