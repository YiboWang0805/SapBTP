...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.APIProxyEndPoint APIProxyEndPoint}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class APIProxyEndPointField<FieldT >
    extends EntityField<APIProxyEndPoint, FieldT>
    implements APIProxyEndPointSelectable
{
     ...
     */
    public APIProxyEndPointField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public APIProxyEndPointField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
