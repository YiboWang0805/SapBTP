...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.APIProxy APIProxy}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class APIProxyField<FieldT >
    extends EntityField<APIProxy, FieldT>
    implements APIProxySelectable
{
     ...
     */
    public APIProxyField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public APIProxyField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
