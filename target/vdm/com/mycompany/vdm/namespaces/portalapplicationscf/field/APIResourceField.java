...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.APIResource APIResource}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class APIResourceField<FieldT >
    extends EntityField<APIResource, FieldT>
    implements APIResourceSelectable
{
     ...
     */
    public APIResourceField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public APIResourceField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
