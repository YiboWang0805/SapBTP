...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.APITargetEndPoint APITargetEndPoint}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class APITargetEndPointField<FieldT >
    extends EntityField<APITargetEndPoint, FieldT>
    implements APITargetEndPointSelectable
{
     ...
     */
    public APITargetEndPointField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public APITargetEndPointField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
