...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Application Application}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ApplicationField<FieldT >
    extends EntityField<Application, FieldT>
    implements ApplicationSelectable
{
     ...
     */
    public ApplicationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ApplicationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
