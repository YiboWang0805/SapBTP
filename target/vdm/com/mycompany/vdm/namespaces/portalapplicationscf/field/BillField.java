...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Bill Bill}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BillField<FieldT >
    extends EntityField<Bill, FieldT>
    implements BillSelectable
{
     ...
     */
    public BillField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BillField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
