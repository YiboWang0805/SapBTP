...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.CacheResource CacheResource}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CacheResourceField<FieldT >
    extends EntityField<CacheResource, FieldT>
    implements CacheResourceSelectable
{
     ...
     */
    public CacheResourceField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CacheResourceField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
