...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Certificate Certificate}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CertificateField<FieldT >
    extends EntityField<Certificate, FieldT>
    implements CertificateSelectable
{
     ...
     */
    public CertificateField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CertificateField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
