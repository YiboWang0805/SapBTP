...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.CertificateStore CertificateStore}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CertificateStoreField<FieldT >
    extends EntityField<CertificateStore, FieldT>
    implements CertificateStoreSelectable
{
     ...
     */
    public CertificateStoreField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CertificateStoreField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
