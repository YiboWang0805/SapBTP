...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.ConditionalFlowRule ConditionalFlowRule}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ConditionalFlowRuleField<FieldT >
    extends EntityField<ConditionalFlowRule, FieldT>
    implements ConditionalFlowRuleSelectable
{
     ...
     */
    public ConditionalFlowRuleField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ConditionalFlowRuleField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
