...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.ContentPackageMapper ContentPackageMapper}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ContentPackageMapperField<FieldT >
    extends EntityField<ContentPackageMapper, FieldT>
    implements ContentPackageMapperSelectable
{
     ...
     */
    public ContentPackageMapperField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ContentPackageMapperField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
