...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.DefaultFaultRule DefaultFaultRule}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class DefaultFaultRuleField<FieldT >
    extends EntityField<DefaultFaultRule, FieldT>
    implements DefaultFaultRuleSelectable
{
     ...
     */
    public DefaultFaultRuleField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public DefaultFaultRuleField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
