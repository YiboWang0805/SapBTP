...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.DestinationAndUrlMapping DestinationAndUrlMapping}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class DestinationAndUrlMappingField<FieldT >
    extends EntityField<DestinationAndUrlMapping, FieldT>
    implements DestinationAndUrlMappingSelectable
{
     ...
     */
    public DestinationAndUrlMappingField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public DestinationAndUrlMappingField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
