...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Developer Developer}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class DeveloperField<FieldT >
    extends EntityField<Developer, FieldT>
    implements DeveloperSelectable
{
     ...
     */
    public DeveloperField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public DeveloperField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
