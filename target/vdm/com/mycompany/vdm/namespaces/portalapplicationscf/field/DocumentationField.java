...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Documentation Documentation}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class DocumentationField<FieldT >
    extends EntityField<Documentation, FieldT>
    implements DocumentationSelectable
{
     ...
     */
    public DocumentationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public DocumentationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
