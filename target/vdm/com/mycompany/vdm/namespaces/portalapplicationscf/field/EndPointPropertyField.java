...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.EndPointProperty EndPointProperty}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EndPointPropertyField<FieldT >
    extends EntityField<EndPointProperty, FieldT>
    implements EndPointPropertySelectable
{
     ...
     */
    public EndPointPropertyField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public EndPointPropertyField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
