...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.FaultRule FaultRule}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FaultRuleField<FieldT >
    extends EntityField<FaultRule, FieldT>
    implements FaultRuleSelectable
{
     ...
     */
    public FaultRuleField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FaultRuleField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
