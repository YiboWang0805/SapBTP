...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.FileResource FileResource}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FileResourceField<FieldT >
    extends EntityField<FileResource, FieldT>
    implements FileResourceSelectable
{
     ...
     */
    public FileResourceField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FileResourceField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
