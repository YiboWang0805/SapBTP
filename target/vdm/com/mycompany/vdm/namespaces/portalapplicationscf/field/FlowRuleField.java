...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.FlowRule FlowRule}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FlowRuleField<FieldT >
    extends EntityField<FlowRule, FieldT>
    implements FlowRuleSelectable
{
     ...
     */
    public FlowRuleField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FlowRuleField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
