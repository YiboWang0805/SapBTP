...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.KeyMapEntry KeyMapEntry}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class KeyMapEntryField<FieldT >
    extends EntityField<KeyMapEntry, FieldT>
    implements KeyMapEntrySelectable
{
     ...
     */
    public KeyMapEntryField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public KeyMapEntryField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
