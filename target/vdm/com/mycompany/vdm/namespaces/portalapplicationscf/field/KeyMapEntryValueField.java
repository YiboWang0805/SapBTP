...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.KeyMapEntryValue KeyMapEntryValue}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class KeyMapEntryValueField<FieldT >
    extends EntityField<KeyMapEntryValue, FieldT>
    implements KeyMapEntryValueSelectable
{
     ...
     */
    public KeyMapEntryValueField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public KeyMapEntryValueField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
