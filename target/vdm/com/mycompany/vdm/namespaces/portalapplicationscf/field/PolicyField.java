...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Policy Policy}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PolicyField<FieldT >
    extends EntityField<Policy, FieldT>
    implements PolicySelectable
{
     ...
     */
    public PolicyField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PolicyField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
