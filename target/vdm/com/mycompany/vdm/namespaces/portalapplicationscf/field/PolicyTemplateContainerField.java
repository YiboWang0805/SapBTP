...
package com.mycompany.vdm.namespaces.portalapplicationscf.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.PolicyTemplateContainer PolicyTemplateContainer}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PolicyTemplateContainerField<FieldT >
    extends EntityField<PolicyTemplateContainer, FieldT>
    implements PolicyTemplateContainerSelectable
{
     ...
     */
    public PolicyTemplateContainerField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PolicyTemplateContainerField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
