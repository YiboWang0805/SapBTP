...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.RatePlan RatePlan}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class RatePlanField<FieldT >
    extends EntityField<RatePlan, FieldT>
    implements RatePlanSelectable
{
     ...
     */
    public RatePlanField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public RatePlanField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
