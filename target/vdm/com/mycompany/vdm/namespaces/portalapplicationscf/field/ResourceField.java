...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Resource Resource}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ResourceField<FieldT >
    extends EntityField<Resource, FieldT>
    implements ResourceSelectable
{
     ...
     */
    public ResourceField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ResourceField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
