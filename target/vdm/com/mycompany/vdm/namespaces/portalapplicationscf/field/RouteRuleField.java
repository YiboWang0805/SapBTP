...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.RouteRule RouteRule}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class RouteRuleField<FieldT >
    extends EntityField<RouteRule, FieldT>
    implements RouteRuleSelectable
{
     ...
     */
    public RouteRuleField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public RouteRuleField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
