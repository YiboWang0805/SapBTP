...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Step Step}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class StepField<FieldT >
    extends EntityField<Step, FieldT>
    implements StepSelectable
{
     ...
     */
    public StepField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public StepField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
