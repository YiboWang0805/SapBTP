...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.Stream Stream}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class StreamField<FieldT >
    extends EntityField<Stream, FieldT>
    implements StreamSelectable
{
     ...
     */
    public StreamField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public StreamField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
