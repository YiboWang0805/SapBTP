...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.TemplateFileResource TemplateFileResource}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TemplateFileResourceField<FieldT >
    extends EntityField<TemplateFileResource, FieldT>
    implements TemplateFileResourceSelectable
{
     ...
     */
    public TemplateFileResourceField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TemplateFileResourceField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
