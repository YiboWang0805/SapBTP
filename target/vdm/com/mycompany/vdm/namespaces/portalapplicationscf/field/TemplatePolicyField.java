...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.TemplatePolicy TemplatePolicy}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TemplatePolicyField<FieldT >
    extends EntityField<TemplatePolicy, FieldT>
    implements TemplatePolicySelectable
{
     ...
     */
    public TemplatePolicyField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TemplatePolicyField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
