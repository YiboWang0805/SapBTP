...
/**
 * Template class to represent entity fields of the Entity {@link com.mycompany.vdm.namespaces.portalapplicationscf.VirtualHost VirtualHost}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class VirtualHostField<FieldT >
    extends EntityField<VirtualHost, FieldT>
    implements VirtualHostSelectable
{
     ...
     */
    public VirtualHostField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public VirtualHostField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
