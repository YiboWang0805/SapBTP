...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.APIProxyEndPoint APIProxyEndPoint} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.APIProxyEndPointLink APIProxyEndPointLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class APIProxyEndPointOneToOneLink<ObjectT extends VdmObject<?> >
    extends APIProxyEndPointLink<ObjectT>
    implements OneToOneLink<APIProxyEndPoint, ObjectT>
{
     ...
     */
    public APIProxyEndPointOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<APIProxyEndPoint> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<APIProxyEndPoint>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
