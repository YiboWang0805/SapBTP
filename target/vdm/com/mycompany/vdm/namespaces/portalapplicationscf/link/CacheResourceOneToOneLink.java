...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.CacheResource CacheResource} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.CacheResourceLink CacheResourceLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CacheResourceOneToOneLink<ObjectT extends VdmObject<?> >
    extends CacheResourceLink<ObjectT>
    implements OneToOneLink<CacheResource, ObjectT>
{
     ...
     */
    public CacheResourceOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CacheResource> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<CacheResource>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
