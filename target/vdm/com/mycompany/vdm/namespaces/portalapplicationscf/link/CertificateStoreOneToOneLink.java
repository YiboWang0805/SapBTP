...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.CertificateStore CertificateStore} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.CertificateStoreLink CertificateStoreLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CertificateStoreOneToOneLink<ObjectT extends VdmObject<?> >
    extends CertificateStoreLink<ObjectT>
    implements OneToOneLink<CertificateStore, ObjectT>
{
     ...
     */
    public CertificateStoreOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CertificateStore> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<CertificateStore>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
