...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.ConditionalFlowRule ConditionalFlowRule} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.ConditionalFlowRuleLink ConditionalFlowRuleLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ConditionalFlowRuleOneToOneLink<ObjectT extends VdmObject<?> >
    extends ConditionalFlowRuleLink<ObjectT>
    implements OneToOneLink<ConditionalFlowRule, ObjectT>
{
     ...
     */
    public ConditionalFlowRuleOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ConditionalFlowRule> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<ConditionalFlowRule>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
