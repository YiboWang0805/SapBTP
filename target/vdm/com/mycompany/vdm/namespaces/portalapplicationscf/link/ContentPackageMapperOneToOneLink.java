...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.ContentPackageMapper ContentPackageMapper} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.ContentPackageMapperLink ContentPackageMapperLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ContentPackageMapperOneToOneLink<ObjectT extends VdmObject<?> >
    extends ContentPackageMapperLink<ObjectT>
    implements OneToOneLink<ContentPackageMapper, ObjectT>
{
     ...
     */
    public ContentPackageMapperOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ContentPackageMapper> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<ContentPackageMapper>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
