...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.DefaultFaultRule DefaultFaultRule} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.DefaultFaultRuleLink DefaultFaultRuleLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class DefaultFaultRuleOneToOneLink<ObjectT extends VdmObject<?> >
    extends DefaultFaultRuleLink<ObjectT>
    implements OneToOneLink<DefaultFaultRule, ObjectT>
{
     ...
     */
    public DefaultFaultRuleOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<DefaultFaultRule> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<DefaultFaultRule>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
