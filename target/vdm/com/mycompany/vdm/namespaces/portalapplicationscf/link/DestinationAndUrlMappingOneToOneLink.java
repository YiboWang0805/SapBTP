...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.DestinationAndUrlMapping DestinationAndUrlMapping} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.DestinationAndUrlMappingLink DestinationAndUrlMappingLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class DestinationAndUrlMappingOneToOneLink<ObjectT extends VdmObject<?> >
    extends DestinationAndUrlMappingLink<ObjectT>
    implements OneToOneLink<DestinationAndUrlMapping, ObjectT>
{
     ...
     */
    public DestinationAndUrlMappingOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<DestinationAndUrlMapping> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<DestinationAndUrlMapping>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
