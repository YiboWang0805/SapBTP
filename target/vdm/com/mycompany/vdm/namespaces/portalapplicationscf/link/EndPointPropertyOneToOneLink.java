...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.EndPointProperty EndPointProperty} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.EndPointPropertyLink EndPointPropertyLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EndPointPropertyOneToOneLink<ObjectT extends VdmObject<?> >
    extends EndPointPropertyLink<ObjectT>
    implements OneToOneLink<EndPointProperty, ObjectT>
{
     ...
     */
    public EndPointPropertyOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EndPointProperty> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<EndPointProperty>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
