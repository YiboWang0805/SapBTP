...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.FileResource FileResource} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.FileResourceLink FileResourceLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FileResourceOneToOneLink<ObjectT extends VdmObject<?> >
    extends FileResourceLink<ObjectT>
    implements OneToOneLink<FileResource, ObjectT>
{
     ...
     */
    public FileResourceOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FileResource> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<FileResource>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
