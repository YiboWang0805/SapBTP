...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.KeyMapEntry KeyMapEntry} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.KeyMapEntryLink KeyMapEntryLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class KeyMapEntryOneToOneLink<ObjectT extends VdmObject<?> >
    extends KeyMapEntryLink<ObjectT>
    implements OneToOneLink<KeyMapEntry, ObjectT>
{
     ...
     */
    public KeyMapEntryOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<KeyMapEntry> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<KeyMapEntry>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
