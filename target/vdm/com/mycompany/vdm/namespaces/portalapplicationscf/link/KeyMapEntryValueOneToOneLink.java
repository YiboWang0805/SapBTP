...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.KeyMapEntryValue KeyMapEntryValue} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.KeyMapEntryValueLink KeyMapEntryValueLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class KeyMapEntryValueOneToOneLink<ObjectT extends VdmObject<?> >
    extends KeyMapEntryValueLink<ObjectT>
    implements OneToOneLink<KeyMapEntryValue, ObjectT>
{
     ...
     */
    public KeyMapEntryValueOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<KeyMapEntryValue> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<KeyMapEntryValue>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
