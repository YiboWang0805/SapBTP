...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.PolicyTemplateContainer PolicyTemplateContainer} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.PolicyTemplateContainerLink PolicyTemplateContainerLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PolicyTemplateContainerOneToOneLink<ObjectT extends VdmObject<?> >
    extends PolicyTemplateContainerLink<ObjectT>
    implements OneToOneLink<PolicyTemplateContainer, ObjectT>
{
     ...
     */
    public PolicyTemplateContainerOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PolicyTemplateContainer> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<PolicyTemplateContainer>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
