...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.RouteRule RouteRule} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.RouteRuleLink RouteRuleLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class RouteRuleOneToOneLink<ObjectT extends VdmObject<?> >
    extends RouteRuleLink<ObjectT>
    implements OneToOneLink<RouteRule, ObjectT>
{
     ...
     */
    public RouteRuleOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<RouteRule> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<RouteRule>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
