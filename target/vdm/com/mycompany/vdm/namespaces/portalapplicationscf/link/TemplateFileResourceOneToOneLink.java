...
/**
 * Template class to represent entity navigation links of {@link com.mycompany.vdm.namespaces.portalapplicationscf.TemplateFileResource TemplateFileResource} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.mycompany.vdm.namespaces.portalapplicationscf.link.TemplateFileResourceLink TemplateFileResourceLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class TemplateFileResourceOneToOneLink<ObjectT extends VdmObject<?> >
    extends TemplateFileResourceLink<ObjectT>
    implements OneToOneLink<TemplateFileResource, ObjectT>
{
     ...
     */
    public TemplateFileResourceOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<TemplateFileResource> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<TemplateFileResource>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
